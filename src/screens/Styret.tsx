...
const members = [
...

  {
    ...
    Text: "Som manus-sjef er jeg selvfølgelig veldig kreativ og flink til å skrive Texter… psyche! Meen, jeg har ansvar for at vi ender opp med en bunch med lættise sketsjer, og DU kan være med å skrive dem! Har du et snev av kreativitet i deg? Liker du å kødde? Er du en edgy motherfucker? Søk manus davel! Dab!",
  },
  {
    pic: Helene,
    hoverpic: Helene2,
    Name: "Helene Tellefsen",
    Text: "Jeg er revyens regissør og det er jeg som har ansvar for alt det kreative på scenen! Til høsten skal vi ta opp skuespillere. Skuespillerne kommer til å stå på scenen, danse og kødde, og de vil delta på revyøvinger med masse leking og impro. Når man jobber sammen for å lage revy, enten som skuespiller eller med en annen rolle, blir man kjent på en helt spesiell måte, og det vil du neppe gå glipp av!",
  },
  {
    pic: Ida,
    hoverpic: Ida2,
    Name: "Ida Ahlsand",
    Text: "Som økonomisjef har du ansvar for å sette opp budsjett for det kommende revyåret, føre regnskap, skaffe sponsor, betale regninger og å holde oversikt over pengeforbruket til revyen. Det krever ingen forkunnskaper, så lenge du er strukturert og engasjert. Husk at uten økonomisjef blir det ingen revy! ",
  },
];
